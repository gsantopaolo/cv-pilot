...
class JobApplicationCrew:
    ...
    """
    _keyword_analyzer: KeywordsAnalyzerTool
    ...
    def __init__(self, resume_path: str, job_desc_path: str):
        ...
        self._keyword_analyzer = KeywordsAnalyzerTool()
        self._mdx_search_tool = MDXSearchTool()
    ...
    def researcher(self) -> Agent:
        return Agent(
            ...
            tools=[self._file_read_tool, self._mdx_search_tool,
                   self._keyword_analyzer],
            llm=self._llm,
            verbose=True,
...
#         return Agent(
#             config=self.agents_config["researcher"],
#             tools=[self._search_tool, self._scrape_website_tool, self._doc_dir_tool, self._file_read_tool, self._keyword_analyzer],
#             llm=self._llm,
#             verbose=True,
...
#         return Agent(
#             config=self.agents_config["resume_strategist"],
#             tools=[self._search_tool, self._scrape_website_tool, self._doc_dir_tool, self._file_read_tool,
#                    self._keyword_analyzer],
#             llm=self._llm,
#             verbose=True,
#             allow_delegation=False
